 ...
 * Generated: 2026-07-05T17:55:13.882Z
 */

import { neutralIconRegistry } from './icons';
/**
 * pancatz theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { pancatzTheme } from './pancatz';
 *   import './pancatz.css';
 */
export const pancatzTheme = {
  name: 'pancatz',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "\"DM Sans\", \"Inter\", system-ui, -apple-system, sans-serif",
    "--font-family-heading": "\"DM Sans\", \"Inter\", system-ui, -apple-system, sans-serif",
    "--font-family-code": "\"Roboto Mono\", ui-monospace, \"SF Mono\", monospace",
    ...
    "--color-background-surface": "light-dark(#fffdf8, #262626)",
    "--color-background-body": "light-dark(#f8f6f1, #1b1b1b)",
    "--color-background-card": "light-dark(#fffdf8, #1b1b1b)",
    "--color-background-popover": "light-dark(#fffdf8, #1b1b1b)",
    "--color-background-muted": "light-dark(#f1f1f1, #1b1b1b)",
    "--color-accent": "light-dark(#0a7f5a, #0a7f5a)",
    "--color-accent-muted": "light-dark(#e6f2ef, #0a7f5a33)",
    ...
    "--color-text-secondary": "light-dark(#52525b, #a3a3a3)",
    "--color-text-disabled": "light-dark(#a3a3a3, #525252)",
    "--color-text-accent": "light-dark(#065f46, #84c980)",
    ...
    "--color-icon-accent": "light-dark(#0a7f5a, #84c980)",
    "--color-icon-primary": "light-dark(#171717, #fafafa)",
    "--color-icon-secondary": "light-dark(#52525b, #a3a3a3)",
