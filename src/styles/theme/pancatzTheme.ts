...
export const pancatzTheme = defineTheme({
  name: 'pancatz',
  ...
  motion: {fast: 160, medium: 280, slow: 700, ratio: 0.75},

  syntax: neutralSyntax,

  tokens: {
    // Pancatz brand colors
    '--color-background-surface': ['#fffdf8', '#262626'],
    '--color-background-body':    ['#f8f6f1', '#1b1b1b'],
    '--color-background-card':    ['#fffdf8', '#1b1b1b'],
    '--color-background-popover': ['#fffdf8', '#1b1b1b'],
    '--color-background-muted':   ['#f1f1f1', '#1b1b1b'],

    '--color-accent':       ['#0a7f5a', '#0a7f5a'], // primary teal
    '--color-accent-muted': ['#e6f2ef', '#0a7f5a33'],
    ...
    '--color-text-secondary': ['#52525b', '#a3a3a3'],
    '--color-text-disabled':  ['#a3a3a3', '#525252'],
    '--color-text-accent':    ['#065f46', '#84c980'],
    ...
    '--color-icon-accent':    ['#0a7f5a', '#84c980'],
    '--color-icon-primary':   ['#171717', '#fafafa'],
    '--color-icon-secondary': ['#52525b', '#a3a3a3'],
